	...
	<div>
		...
		<el-card>
			...
			<el-table :data="sortList" border stripe>
				...
				<el-table-column label="分类父级id" prop="cat_pid"></el-table-column>
				<el-table-column label="分类级别" prop="cat_level"></el-table-column>
				<el-table-column label="分类图标" prop="cat_icon">
					<template slot-scope="scope">
						<img :src="scope.row.cat_icon" />
					</template>
				</el-table-column>
