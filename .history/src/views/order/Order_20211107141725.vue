		...
		<el-card>
			...
			<el-table :data="orderList" border stripe>
				...
				<el-table-column type="expand">
					<template v-for="item in prod_list" slot-scope="item">
						<el-form label-position="left" inline class="demo-table-expand">
							<el-form-item label="商品名称">
								<span>{{ item.row.product_title }}</span>
							</el-form-item>
							<!-- <el-form-item label="所属店铺">
								<span>{{ prod_list.row.shop }}</span>
							</el-form-item>
							<el-form-item label="商品 ID">
								<span>{{ prod_list.row.id }}</span>
							</el-form-item>
							<el-form-item label="店铺 ID">
								<span>{{ prod_list.row.shopId }}</span>
							</el-form-item>
							<el-form-item label="商品分类">
								<span>{{ prod_list.row.category }}</span>
							</el-form-item>
							<el-form-item label="店铺地址">
								<span>{{ prod_list.row.address }}</span>
							</el-form-item>
							<el-form-item label="商品描述">
								<span>{{ prod_list.row.desc }}</span>
							</el-form-item> -->
						</el-form>
					</template>
				</el-table-column>
