	...
	<div id="member">
		...
		>
			...
			>
				...
				<el-form-item label="性别" prop="gender">
					<el-radio-group v-model="radio">
						<el-radio v-model="addForm.gender" label="">男</el-radio>
						<el-radio v-model="addForm.gender" label="">女</el-radio>
					</el-radio-group>
				</el-form-item>
			...
			<span slot="footer" class="dialog-footer">
				<el-button type="primary" plain round @click="addMember"
					>确 定</el-button
				>
...
export default {
	...
	methods: {
		...
		//监听 可用状态改变的事件
		memberStatusChanged(memberInfo) {
			console.log(memberInfo);
			// const { data: res } = this.$http.post("members/update", memberInfo);
