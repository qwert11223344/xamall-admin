					...
					<template slot-scope="scope">
						...
						<el-tooltip effect="dark" content="删除" placement="top">
							...
							<el-button
								...
								circle
								size="mini"
								@click="_delGoods({ product_id: scope.row.product_id })"
							></el-button>
						</el-tooltip>
					</template>
				</el-table-column>
...
export default {
	...
	methods: {
		...
		async _getAllGoods() {
			...
			this.itemList = this.$route.params.goodsList || limitGoods.data;
